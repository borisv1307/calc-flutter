...
class MatrixPrimaryPad extends StatelessWidget{
  final Function(InputItem input) inputFunction;
  final Function(CommandItem command) commandFunction;

  MatrixPrimaryPad(this.inputFunction, this.commandFunction);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child:GridView.count(
        ...
        children:[
          PadButton('2nd', InputButtonStyle.SECONDARY, () {Navigator.pushReplacementNamed(context, 'matrPadTwo');}),

...
class MatrixSecondaryPad extends StatelessWidget{

  final Function(InputItem input) inputFunction;
  final Function(CommandItem command) commandFunction;

  MatrixSecondaryPad(this.inputFunction, this.commandFunction);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child:GridView.count(
        ...
        children:[
          PadButton('Back', InputButtonStyle.SECONDARY, () {Navigator.pushReplacementNamed(context, 'matrPadOne');}),

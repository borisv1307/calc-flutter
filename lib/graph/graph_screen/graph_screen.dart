...
class GraphScreenState extends State<GraphScreen> {
  ...
  Widget build(BuildContext context) {
    this.inputEquations = GraphLines(widget.evaluator
        .translateInputs(
            widget.controller.inputs, SettingsController.of(context))
        .map((equation) => GraphLine(equation))
        .toList());
    InteractiveGraph interactiveGraph = InteractiveGraph(
        this.inputEquations, this.scaleSettings, this.cursorDetails);

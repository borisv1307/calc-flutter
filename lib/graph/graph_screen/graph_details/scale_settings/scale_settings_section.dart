      ...
      child: Row(
        children: [
          Expanded(
            child: Column(
              children: [
                _buildFormField('X min', scaleSettings.xMin, (input) {
                  scaleSettings.xMin = int.parse(input);
                }),
                _buildFormField('X max', scaleSettings.xMax, (input) {
          ...
          Expanded(
              child: Column(
            children: [
              _buildFormField('Y min', scaleSettings.yMin, (input) {
                scaleSettings.yMin = int.parse(input);
              }),
              _buildFormField('Y max', scaleSettings.yMax, (input) {
          ...
          Expanded(
            child: Column(
              children: [
                _buildFormField('step', scaleSettings.step, (input) {

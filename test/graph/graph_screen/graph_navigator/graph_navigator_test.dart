...
void main() {
  Widget _buildTestableNavigator(Coordinates cursorLocation,
      Function(Coordinates updatedLocation) moveCursor) {
    GraphCursor cursor = GraphCursor();
    cursor.location = cursorLocation;
    cursor.step = 3;
    ScaleSettings scaleSettings;
    return MaterialApp(
        home: GraphNavigator(cursor, moveCursor,
            TextToggleSelection('equations'), scaleSettings));
  }
  ...
  group('Arrows', () {
    testWidgets("can navigate cursor up", (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
          _buildTestableNavigator(Coordinates(0, 0), (Coordinates u) {
